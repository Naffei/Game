...
public class Boss : MonoBehaviour, IAttackable
{
    ...
    void Update()
    {
        // Check if player is in room if so face the player
    ...
    // Idle Phase where boss doesnt attack player
